 ...
 */
final class Version20200328100117 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ligne_panier_commande (id INT AUTO_INCREMENT NOT NULL, panier_id INT DEFAULT NULL, commande_id INT DEFAULT NULL, quantite VARCHAR(255) DEFAULT NULL, INDEX IDX_FF4ECE1CF77D927C (panier_id), INDEX IDX_FF4ECE1C82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, nb_articles INT DEFAULT NULL, total INT DEFAULT NULL, UNIQUE INDEX UNIQ_24CC0DF219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, quantite VARCHAR(255) NOT NULL, prix VARCHAR(255) NOT NULL, INDEX IDX_29A5EC27BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
